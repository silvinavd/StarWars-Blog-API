...
router.post('/:user_id/favourite/planet/:planet_id', verifyToken, utils_1.safe(actions.addPlanet));
...
router["delete"]('/:user_id/favourite/planet/:planet_id', utils_1.safe(actions.deletePlanet));
